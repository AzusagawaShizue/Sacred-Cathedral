    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          >
            <div>
              <h3 className="text-[#1E2A5A] mb-1">{nft.name}</h3>
              <p className="text-sm text-[#1E2A5A]/70 leading-relaxed">{nft.description}</p>
            </div>

            <div className="flex items-center justify-between p-4 rounded-xl glass-gold">
              <span className="text-sm text-[#1E2A5A]/70">预估价值</span>
              <span className="text-[#1E2A5A] font-mono">{nft.price?.toFixed(3)} ETH</span>
            </div>

            <div className="flex items-center justify-between p-4 rounded-xl glass-morphism">
              <span className="text-sm text-[#295EE7]/70">类型</span>
              <span className="text-[#295EE7]">
                {nft.type === 'relic' && '圣物'}
                {nft.type === 'avatar' && '头像'}
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={onClose}
              className="py-3 rounded-xl glass-morphism hover:glass-gold text-[#1E2A5A] transition-all duration-300 shadow-md"
            >
              继续祈祷
            </motion.button>
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="py-3 rounded-xl bg-gradient-to-r from-[#295EE7] to-[#1E2A5A] text-white shadow-xl relative overflow-hidden"
            >
              <motion.div
