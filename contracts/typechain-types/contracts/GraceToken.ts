...
export interface GraceTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface GraceToken extends BaseContract {
  connect(runner?: ContractRunner | null): GraceToken;
  waitForDeployment(): Promise<this>;

  interface: GraceTokenInterface;
